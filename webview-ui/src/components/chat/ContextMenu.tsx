    ...
    >
      ...
      >
        ...
        {filteredOptions.map((option, index) => {
          ...
          const workspacePrefix = option.workspaceName
            ? `${option.workspaceName}:`
            : "";
          const generatedKey = `${option.type}-${workspacePrefix}${
            option.value || index
          }`;
            ...
            <div
              ...
              onClick={() => {
                if (isOptionSelectable(option)) {
                  ...
                  const mentionValue = option.label?.includes(":")
                    ? option.label
                    : option.value;
